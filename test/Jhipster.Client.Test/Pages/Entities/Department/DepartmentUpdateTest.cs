...
public class DepartmentUpdateTest : TestContext
{
    ...
    public void Should_UpdateSelectedDepartment_When_FormIsSubmitWithId()
    {
        ...
        var updateDepartmentPage = RenderComponent<Jhipster.Client.Pages.Entities.Department.DepartmentUpdate>(ComponentParameter.CreateParameter("Id", 1L));
    ...
    public void Should_AddDepartment_When_FormIsSubmitWithoutId()
    {
        ...
        var updateDepartmentPage = RenderComponent<Jhipster.Client.Pages.Entities.Department.DepartmentUpdate>(ComponentParameter.CreateParameter("Id", 0L));
