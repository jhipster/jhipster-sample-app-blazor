...
public class RegionUpdateTest : TestContext
{
    ...
    public void Should_UpdateSelectedRegion_When_FormIsSubmitWithId()
    {
        ...
        var updateRegionPage = RenderComponent<Jhipster.Client.Pages.Entities.Region.RegionUpdate>(ComponentParameter.CreateParameter("Id", 1L));
    ...
    public void Should_AddRegion_When_FormIsSubmitWithoutId()
    {
        ...
        var updateRegionPage = RenderComponent<Jhipster.Client.Pages.Entities.Region.RegionUpdate>(ComponentParameter.CreateParameter("Id", 0L));
