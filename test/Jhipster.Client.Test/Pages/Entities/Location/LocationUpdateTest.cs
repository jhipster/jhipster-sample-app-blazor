...
public class LocationUpdateTest : TestContext
{
    ...
    public void Should_UpdateSelectedLocation_When_FormIsSubmitWithId()
    {
        ...
        var updateLocationPage = RenderComponent<Jhipster.Client.Pages.Entities.Location.LocationUpdate>(ComponentParameter.CreateParameter("Id", 1L));
    ...
    public void Should_AddLocation_When_FormIsSubmitWithoutId()
    {
        ...
        var updateLocationPage = RenderComponent<Jhipster.Client.Pages.Entities.Location.LocationUpdate>(ComponentParameter.CreateParameter("Id", 0L));
