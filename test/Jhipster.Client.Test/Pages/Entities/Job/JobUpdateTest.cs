...
public class JobUpdateTest : TestContext
{
    ...
    public void Should_UpdateSelectedJob_When_FormIsSubmitWithId()
    {
        ...
        var updateJobPage = RenderComponent<Jhipster.Client.Pages.Entities.Job.JobUpdate>(ComponentParameter.CreateParameter("Id", 1L));
    ...
    public void Should_AddJob_When_FormIsSubmitWithoutId()
    {
        ...
        var updateJobPage = RenderComponent<Jhipster.Client.Pages.Entities.Job.JobUpdate>(ComponentParameter.CreateParameter("Id", 0L));
