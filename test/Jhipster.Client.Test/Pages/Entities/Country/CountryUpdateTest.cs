...
public class CountryUpdateTest : TestContext
{
    ...
    public void Should_UpdateSelectedCountry_When_FormIsSubmitWithId()
    {
        ...
        var updateCountryPage = RenderComponent<Jhipster.Client.Pages.Entities.Country.CountryUpdate>(ComponentParameter.CreateParameter("Id", 1L));
    ...
    public void Should_AddCountry_When_FormIsSubmitWithoutId()
    {
        ...
        var updateCountryPage = RenderComponent<Jhipster.Client.Pages.Entities.Country.CountryUpdate>(ComponentParameter.CreateParameter("Id", 0L));
