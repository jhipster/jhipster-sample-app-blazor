...
public class EmployeeUpdateTest : TestContext
{
    ...
    public void Should_UpdateSelectedEmployee_When_FormIsSubmitWithId()
    {
        ...
        var updateEmployeePage = RenderComponent<Jhipster.Client.Pages.Entities.Employee.EmployeeUpdate>(ComponentParameter.CreateParameter("Id", 1L));
    ...
    public void Should_AddEmployee_When_FormIsSubmitWithoutId()
    {
        ...
        var updateEmployeePage = RenderComponent<Jhipster.Client.Pages.Entities.Employee.EmployeeUpdate>(ComponentParameter.CreateParameter("Id", 0L));
