...
public class JobHistoryUpdateTest : TestContext
{
    ...
    public void Should_UpdateSelectedJobHistory_When_FormIsSubmitWithId()
    {
        ...
        var updateJobHistoryPage = RenderComponent<Jhipster.Client.Pages.Entities.JobHistory.JobHistoryUpdate>(ComponentParameter.CreateParameter("Id", 1L));
    ...
    public void Should_AddJobHistory_When_FormIsSubmitWithoutId()
    {
        ...
        var updateJobHistoryPage = RenderComponent<Jhipster.Client.Pages.Entities.JobHistory.JobHistoryUpdate>(ComponentParameter.CreateParameter("Id", 0L));
